    ...
    <x-tallui-card padding="none" :shadow="true">
        ...
        <div class="overflow-x-auto">
            <table class="table table-sm w-full">
                <thead><tr class="bg-base-300 text-xs text-base-content/60 uppercase tracking-wide border-b border-base-300"><th class="pl-5">Product</th><th>Available</th><th>Qty</th><th>Unit Cost</th><th>Notes</th><th class="pr-5"></th></tr></thead>
                <tbody>
