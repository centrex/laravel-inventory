...
<x-tallui-page-header title="Purchase Report" subtitle="Purchase totals, shipping, supplier payments, and product intake." icon="o-arrow-down-tray">
    ...
    <x-slot:actions>
        <div class="flex flex-wrap items-center gap-2">
            ...
            <x-tallui-input type="date" wire:model.live="startDate" wire:loading.attr="disabled" wire:target="startDate,endDate,supplierId,productId" class="input-sm" />
            <x-tallui-input type="date" wire:model.live="endDate" wire:loading.attr="disabled" wire:target="startDate,endDate,supplierId,productId" class="input-sm" />
            <span wire:loading wire:target="startDate,endDate,supplierId,productId" class="flex items-center gap-1 text-xs text-base-content/60">
