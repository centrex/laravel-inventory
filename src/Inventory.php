...
use Centrex\Inventory\Models\{Adjustment, Customer, CustomerProductStat, Lot, PickList, PickListItem, Product, ProductCategory, ProductTrendSnapshot, ProductVariant, ProductVariantAttributeType, ProductVariantAttributeValue, PurchaseOrder, PurchaseOrderItem, SaleOrder, SaleOrderItem, SerialNumber, Shipment, ShipmentBox, ShipmentBoxItem, ShipmentItem, StockMovement, StockReceipt, StockReceiptItem, Supplier, SupplierProductStat, Transfer, Warehouse, WarehouseProduct};
